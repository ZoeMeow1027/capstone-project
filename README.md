...
| -				| -																| -				| -								|
| Product		| Manage phones, categories and manufacturers in inventory.		| 2023/04/21	| <ul><li>[x] Add</li><li>[x] Update</li><li>[x] Hide (or delete)</li><li>[x] Get (1 or list by query or all)</li></ul> |
